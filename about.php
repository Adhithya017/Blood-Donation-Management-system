...
<div class="col-12" style="height: 350px">
    ...
    <div id="nav" class="col-12">
        <ul>
          ...
          <li><a href="contact.php">Suggestion</a></li>
    ...
    <div style="margin: 0; padding: 2% 5% 2% 5%; text-align: center; overflow: auto;">
        ...
        <h4 style="color: rgb(116, 118, 122); text-align: center;">OUR MISSION</h4>
        <p style="color: rgb(116, 118, 122); text-align: left;">Our mission is to build a reliable and accessible platform that connects voluntary blood donors with those in critical need. We strive to create a network that ensures a sufficient and safe blood supply for everyone, every time.</p>
