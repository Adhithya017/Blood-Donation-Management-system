...
<div class="col-12" style="height: 350px;">
    ...
    <div id="nav" class="col-12">
        <ul>
          ...
          <li><a class="active" href="contact.php">Suggestion</a></li>
    ...
    <span class="info2" style="left: 40%">Suggestion</span>
...
<br>
    <div style="margin: 0; padding: 0; text-align: center; overflow: auto;">
        ...
        <div class="col-3" style="width: 15%; float: right; background-color: rgb(217, 219, 224); overflow: auto; text-align: left; margin: 0 3% 3% 3%">
            ...
            <div align="center" style="height: 120px; width: 120px; margin: 5% auto;"><img class="im" src="random_person.jpg"></div>
            
            <p align="center" style="color: rgb(76, 109, 86); font-size: 20px;margin: 5%;">Bowen Higgins</p>
